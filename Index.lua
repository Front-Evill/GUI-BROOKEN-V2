...
function Window:AddTab(config)
    ...
    function Tab:AddSection(sectionName)
        ...
        SectionLayout.FillDirection = Enum.AutomaticSize.Y
        ...
        function Section:AddParagraph(config)
            ...
            local ParagraphContent = config.Content or "Paragraph content"
            ...
            ToggleClick.MouseButton1Click:Connect(function()
                if ToggleConfirm then
                    Window:Notify({
                        ...
                        Content = "Are you sure you want to " .. (isToggled and "disable" or "enable") .. " this toggle?",
                        Duration = 0,
                        Actions = {
                            {
                                Title = "Yes",
        ...
        function Section:AddSlider(sliderId, config)
            ...
            SliderFrame.Size = UDim2.new(1, 0, 0, SliderDesc ~= "" and 85 or 65)
            ...
            SliderValueLabel.BackgroundColor3 = Theme.Accent
            SliderValueLabel.BackgroundTransparency = 0.1
            SliderValueLabel.BorderSizePixel = 0
            SliderValueLabel.Size = UDim2.fromOffset(60, 22)
            SliderValueLabel.Position = UDim2.new(1, -70, 0, SliderDesc ~= "" and 6 or 12)
            ...
            SliderValueCorner.CornerRadius = UDim.new(0, 8)
            SliderValueCorner.Parent = SliderValueLabel
            ...
            if SliderDesc ~= "" then
                ...
                SliderDescLabel.Size = UDim2.new(1, -80, 0, 20)
            ...
            local function UpdateSlider(newValue)
                ...
                if SliderRounding then
                    SliderValue = math.round(SliderValue / SliderRounding) * SliderRounding
                end
            ...
            UserInputService.InputEnded:Connect(function(input)
                if input.UserInputType == Enum.UserInputType.MouseButton1 then
                    isDragging = false
                    CreateTween(SliderKnob, TweenInfo.new(0.2, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
                        Size = UDim2.fromOffset(16, 16)
                    }):Play()
                end
            end)
            ...
            UserInputService.InputChanged:Connect(function(input)
                if isDragging and input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    local relativeX = (mouseX - trackPosition.X) / trackSize.X
            ...
            local function AnimateSlider(isEnter)
                if isEnter then
        ...
        function Section:AddDropdown(dropdownId, config)
            ...
            local DropdownDefault = config.Default or (config.Multi and {} or 1)
            ...
            if DropdownMulti then
                ...
                if type(DropdownDefault) == "number" and DropdownValues[DropdownDefault] then
                    SelectedValues = {DropdownValues[DropdownDefault]}
                elseif type(DropdownDefault) == "string" then
                    SelectedValues = {DropdownDefault}
                end
            end
            ...
            DropdownValueLabel.Size = UDim2.new(1, -50, 0, 16)
            DropdownValueLabel.Position = UDim2.fromOffset(15, DropdownDesc ~= "" and 42 or 22)
            DropdownValueLabel.Text = #SelectedValues == 0 and "None" or (DropdownMulti and table.concat(SelectedValues, ", ") or SelectedValues[1])
            ...
            if DropdownDesc ~= "" then
                ...
                DropdownDescLabel.Size = UDim2.new(1, -50, 0, 16)
            ...
            DropdownList.Position = UDim2.fromOffset(10, DropdownDesc ~= "" and 72 or 52)
            ...
            local function UpdateDropdownText()
                if #SelectedValues == 0 then
                    DropdownValueLabel.Text = "None"
                elseif DropdownMulti then
                    DropdownValueLabel.Text = table.concat(SelectedValues, ", ")
                else
                    DropdownValueLabel.Text = SelectedValues[1] or "None"
                end
            end
            ...
            local function CreateDropdownOption(value, index)
                ...
                OptionFrame.BackgroundColor3 = isSelected and Theme.Accent or Theme.Tertiary
                OptionFrame.BackgroundTransparency = isSelected and 0.8 or 1
                ...
                OptionLabel.TextColor3 = isSelected and Theme.Accent or Theme.Text
                ...
                OptionCheck.Size = UDim2.fromOffset(16, 16)
                OptionCheck.Position = UDim2.new(1, -22, 0.5, -8)
                OptionCheck.Text = isSelected and "✓" or ""
                ...
                OptionFrame.MouseButton1Click:Connect(function()
                    if DropdownMulti then
                        ...
                        for i, selectedValue in pairs(SelectedValues) do
                            if selectedValue == value then
                                foundIndex = i
                                break
                            end
                        ...
                        for _, otherOption in pairs(DropdownList:GetChildren()) do
                            if otherOption:IsA("TextButton") and otherOption ~= OptionFrame then
                                local otherCheck = otherOption:FindFirstChild("TextLabel")
                                local otherLabel = otherOption:FindFirstChildOfClass("TextLabel")
                                if otherCheck and otherLabel then
                                    otherCheck.Text = ""
                                    otherLabel.TextColor3 = Theme.Text
                                    CreateTween(otherOption, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {
                                        BackgroundTransparency = 1
                                    }):Play()
                                end
                            end
            ...
            local function ToggleDropdown()
                ...
                if isOpen then
                    ...
                    for i, value in pairs(DropdownValues) do
                        CreateDropdownOption(value, i)
                    end
                    
                    local listHeight = (#DropdownValues * 30) + 10
                    listHeight = math.min(listHeight, 200)
                    
                    CreateTween(DropdownList, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                        Size = UDim2.new(1, -20, 0, listHeight)
                    }):Play()
                    
                    CreateTween(DropdownFrame, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                        Size = UDim2.new(1, 0, 0, (DropdownDesc ~= "" and 72 or 52) + listHeight + 10)
                    }):Play()
                else
                    CreateTween(DropdownList, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
                        Size = UDim2.new(1, -20, 0, 0)
                    }):Play()
                    
                    CreateTween(DropdownFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
            ...
            local function AnimateDropdown(isEnter)
                if isEnter then
        ...
        function Section:AddInput(inputId, config)
            ...
            if InputDesc ~= "" then
                ...
                InputDescLabel.Position = UDim2.fromOffset(15, 28)
        ...
        InputBox.FocusLost:Connect(function(enterPressed)
            ...
            if InputFinished and enterPressed then
                UpdateInput(InputBox.Text)
            elseif not InputFinished then
                UpdateInput(InputBox.Text)
            end
        end)
        ...
        local function AnimateInput(isEnter)
            if isEnter then
